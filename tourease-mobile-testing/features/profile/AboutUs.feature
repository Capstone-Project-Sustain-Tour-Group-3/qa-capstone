Feature: About Us
  As a user 
  I can access about us feature
  So that I can view about the application
  
  Scenario: Can view about the application
    ...
    Then I click Tentang Kami section
    Then I redirected to the about us page